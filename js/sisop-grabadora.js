...
(function () {
  ...
  window.buildGrabadora = function (cfg, bd) {
    ...
    wrap.innerHTML = [
      ...
      '        <button type="button" class="rec-tbtn" data-rec="rew" aria-label="Rebobinar" title="Rebobinar">⏪︎</button>',
      '        <button type="button" class="rec-tbtn rec-tbtn-play" data-rec="playpause" aria-label="Reproducir" title="Reproducir">▶︎</button>',
      '        <button type="button" class="rec-tbtn" data-rec="fwd" aria-label="Adelantar" title="Adelantar">⏩︎</button>',
